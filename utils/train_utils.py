...
def train_single_epoch(
    ...
    print("====> Epoch: {} Average loss: {:.4f}, Accuracy: {:.2f}%".format(epoch, train_loss / len(train_loader), accuracy))
...
def test_single_epoch(epoch, model, test_val_loader, device, loss_function="cross_entropy"):
    ...
    accuracy = 100.0 * correct / total
    print("======> Test set loss: {:.4f}, Accuracy: {:.2f}%".format(loss / len(test_val_loader), accuracy))
    return loss / len(test_val_loader), accuracy
