...
def training_args():
    ...
    default_dataset = "colon_data"
    dataset_root = "/home/shpark/Colonoscopy_Dataset/Train(SNUH)/"
    ood_dataset = "colon_ood" # /home/shpark/Colonoscopy_Dataset/SSL, SP
    train_batch_size = 64 
    test_batch_size = 64
    ...
    save_interval = 50
    save_loc = "./log/"
    saved_model_name = "resnet50_colon_50.model"
    epoch = 350
...
def eval_args():
    ...
    ood_dataset = "ssl_sp"
    batch_size = 128
    load_loc = "/home/shpark/DDU/log/colonoscopy_resnet50_sn_3.0_1_502024-04-08 20:54:30.pth"
    model = "resnet50"
    sn_coeff = 3.0
    runs = 5
    ensemble = 5
